...
// username: tripathysushobhan
// pass: tBZaLxk8OAqwhWbP
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@jobportal.a2ilieo.mongodb.net/?retryWrites=true&w=majority`;
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@job-portal-demo.z34braq.mongodb.net/?appName=job-portal-demo`;
